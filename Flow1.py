...
train_frame.apply_moving_average(input_column='value', window=5)
train_frame.apply_moving_std(input_column='value', window=5)

test_frame.apply_moving_average(input_column='value', window=5)
test_frame.apply_moving_std(input_column='value', window=5)
